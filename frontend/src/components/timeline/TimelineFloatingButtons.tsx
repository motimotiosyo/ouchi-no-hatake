    ...
    <div className="fixed bottom-28 left-1/2 transform -translate-x-1/2 w-full max-w-2xl px-4 pointer-events-none z-40">
      <div className="flex justify-between items-center">
        <div className="relative">
          <button onClick={onFilterClick} className={`w-14 h-14 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center pointer-events-auto ${hasFilter ? 'bg-blue-500 hover:bg-blue-600 text-white' : 'bg-white hover:bg-gray-50 text-blue-600 border-2 border-blue-500'}`}>
        ...
        {user && (
          <button onClick={onCreateClick} className="w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center pointer-events-auto">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
