    ...
    <footer className="fixed bottom-0 left-0 right-0 bg-[#95FB99] py-2 px-4 md:py-3 md:px-4 shadow z-50">
      <div className="flex justify-center">
        ...
        <div className="flex items-center justify-between">
          {/* ホーム */}
          <Link href="/" className="flex flex-col items-center justify-start w-14 md:w-28 py-0 px-0.5 md:py-0 md:px-2">
          ...
          {/* 成長記録 */}
          <Link href="/growth-records" className="flex flex-col items-center justify-start w-14 md:w-28 py-0 px-0.5 md:py-0 md:px-2">
            <svg className="w-6 h-6 md:w-8 md:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* 育て方ガイド */}
          <Link href="/guides" className="flex flex-col items-center justify-start w-14 md:w-28 py-0 px-0.5 md:py-0 md:px-2">
            <svg className="w-6 h-6 md:w-8 md:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* 家庭菜園チェッカー */}
          <Link href="/checker" className="flex flex-col items-center justify-start w-14 md:w-28 py-0 px-0.5 md:py-0 md:px-2">
            <svg className="w-6 h-6 md:w-8 md:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* マイページ */}
          <Link href="/profile" className="flex flex-col items-center justify-start w-14 md:w-28 py-0 px-0.5 md:py-0 md:px-2">
            <svg className="w-6 h-6 md:w-8 md:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
